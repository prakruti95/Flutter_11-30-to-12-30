...
class _UploadDataPageState extends State<UploadDataPage>
{
  ...
  Future<void> _uploadData() async {
    try {
      // API endpoint
      var url = Uri.parse('https://prakrutitech.buzz/Upload/upload1.php');

      // Prepare data to be sent
        var request = http.MultipartRequest('POST', url)
        ..fields['name'] = _textController.text
        ..files.add(await http.MultipartFile.fromPath('url', _imageFile.path));
