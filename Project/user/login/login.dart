...
import 'package:project1/user/login/widgets/custom_clippers/brown_top_clipper.dart';
import 'package:project1/user/login/widgets/custom_clippers/gold_top_clipper.dart';
import 'package:project1/user/login/widgets/custom_clippers/lightgold_top_clipper.dart';
import 'package:project1/user/login/widgets/header.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Login here using your username and password.',
                          style: Theme.of(context).textTheme.titleMedium!.copyWith(color: kDarkBrown.withOpacity(0.7)),
                        ),
                        ...
                        ConstrainedBox(
                          ...
                          child: TextButton(
                            ...
                            child: Text("Login to continue",
                              style: Theme.of(context).textTheme.titleMedium!.copyWith(color: kGold, fontWeight: FontWeight.bold),
                            ),
                          ),
                        ),
                        ...
                        ConstrainedBox(
                          ...
                          child: TextButton(
                            ...
                            child: Text("Forgot a E-wishes Password?",
                              style: Theme.of(context).textTheme.titleMedium!.copyWith(color: kDarkBrown,fontSize:15 , fontWeight: FontWeight.bold),
                            ),
                          ),
                        ),
                        ...
                        ConstrainedBox(
                          ...
                          child: TextButton(
                            ...
                            child: Text("Create an E-wishes Account",
                              style: Theme.of(context).textTheme.titleMedium!.copyWith(color: kLightGold, fontSize: 15, fontWeight: FontWeight.bold),
                            ),
                          ),
                        ),
                        // SizedBox(height: space),
